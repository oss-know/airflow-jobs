...
def bulk_github_pull_requests(now_github_issues, opensearch_client, owner, repo):
...
def init_sync_github_pull_requests(github_tokens, opensearch_conn_info, owner, repo, since=None):
    ...
    for page in range(1, 10000):
        ...
        bulk_github_pull_requests(one_page_github_issues, opensearch_client, owner, repo)
