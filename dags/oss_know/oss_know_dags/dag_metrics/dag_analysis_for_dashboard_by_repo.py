...
with DAG(
    ...
    def do_get_alter_files_count(params):
        ...
        owner = params["owner"]
        repo = params["repo"]
        get_alter_files_count(owner=owner, repo=repo)
        return "end::do_analysis_for_dashboard"
    ...
    def do_get_dir_contributer_count(params):
        ...
        owner = params["owner"]
        repo = params["repo"]
        get_dir_contributer_count(owner=owner, repo=repo)
        return "end::do_analysis_for_dashboard"
    ...
    def do_get_alter_file_count_by_dir_email_domain(params):
        ...
        owner = params["owner"]
        repo = params["repo"]
        get_alter_file_count_by_dir_email_domain(owner=owner, repo=repo)
        return "end::do_analysis_for_dashboard"
    ...
    def do_get_contributer_by_dir_email_domain(params):
        ...
        owner = params["owner"]
        repo = params["repo"]
        get_contributer_by_dir_email_domain(owner=owner, repo=repo)
        return "end::do_analysis_for_dashboard"
    ...
    def do_get_tz_distribution(params):
        ...
        owner = params["owner"]
        repo = params["repo"]
        get_tz_distribution(owner=owner, repo=repo)
        return "end::do_analysis_for_dashboard"
