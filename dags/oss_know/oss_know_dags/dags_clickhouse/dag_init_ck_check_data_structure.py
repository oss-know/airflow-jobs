...
with DAG(
        dag_id='init_ck_check_data_structure',
        schedule_interval=None,
        start_date=datetime(2021, 1, 1),
        catchup=False,
        tags=['clickhouse'],
) as dag:
    def init_check_data_structure(ds, **kwargs):
        return 'Start init_ck_check_data_structure'


    op_init_check_data_structure = PythonOperator(
        task_id='init_clickhouse_transfer_data',
        python_callable=init_check_data_structure,
    )


    def do_ck_check_data_structure(params):
        ...
        transfer_data = init_ck_transfer_data.transfer_data_check_structure(clickhouse_server_info=clickhouse_server_info,
