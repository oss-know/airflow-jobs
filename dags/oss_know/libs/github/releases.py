...
from oss_know.libs.base_dict.opensearch_index import OPENSEARCH_INDEX_GITHUB_RELEASES
...
def sync_releases(opensearch_conn_info, owner, repo, token_proxy_accommodator):
    ...
    query_result = opensearch_client.search(index=OPENSEARCH_INDEX_GITHUB_RELEASES, body=query_body)
    if query_result['hits']['hits']:
        ...
        latest_release = opensearch_client.search(index=OPENSEARCH_INDEX_GITHUB_RELEASES, body=query_body)
